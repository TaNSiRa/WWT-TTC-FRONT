...
class PATTERNTTCVAR {
  ...
  static String TYPE = '';
  static String CUSTNAMEUID = '';
  static String TYPEUID = '';
  static String UID = '';

  static String ITEMSETNOstr = '';
  static int ITEMSETNOint = 0;

  static List<String> SAMPLENO = [
    '-',
    '-',
    '-',
    '-',
  ...
  static List<String> SAMPLENOUID = [
    '',
    '',
    '',
    '',
